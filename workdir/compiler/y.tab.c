...
{
  "$end", "error", "$undefined", "ADD", "SUB", "MUL", "DIV", "NUM", "'('",
...
#line 29 "compiler.y"
                            {   printf("Result: %d\n", calc((yyvsp[0].node)));
                                ...
                                infix((yyvsp[0].node));
                                printf("\n");
                                postfix((yyvsp[0].node));
                                printf("\n");
                                execGen((yyvsp[0].node), output);
                                exit(0);
                            }
#line 1331 "y.tab.c"
    break;
  ...
  case 3:
#line 40 "compiler.y"
                            {   (yyval.node) = createInternalNode('+', (yyvsp[-2].node), (yyvsp[0].node)); }
#line 1337 "y.tab.c"
    break;
